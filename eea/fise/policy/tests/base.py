...
class EEAFixture(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        """Setup Zope"""
        import eea.fise.policy

        self.loadZCML(package=eea.fise.policy)
        ...
        z2.installProduct(app, "eea.fise.policy")

    def setUpPloneSite(self, portal):
        """Setup Plone"""
        applyProfile(portal, "eea.fise.policy:default")
    ...
    def tearDownZope(self, app):
        ...
        z2.uninstallProduct(app, "eea.fise.policy")
